...
#include "test_package/DroneTrajectory.h"
#include "mavros_msgs/CommandBool.h"
#include "mavros_msgs/SetMode.h"
#include "std_srvs/Empty.h"
#include "test_package/StringSrv.h"
...
public:
    ...
    bool callback_set_mode(test_package::StringSrv::Request &req, test_package::StringSrv::Response &resp);
    void spin();
